...
```text
โจทย์ให้เขียนโปรเเกรมรับความยาว 5 อักขระ เเล้วทำการ Reverse String 

Input :
รับ string เข้ามาเป็นภาษาอังกฤษ 5 ตัวอักษร

Output :
เเสดงข้อความที่ทำการ Reverse String เรียบร้อยเเล้ว

Constraints :
Output เป็นตัวอักษรภาษาอังกฤษเป็นพิมพ์เล็ก
```
...
```text
1. รับ input เข้ามาเป็น string 
2. ใช้ความรู้เรื่อง index str ในการ Reverse String
3. เเสดงผลอักษรที่ทำการ Reverse String เรียบร้อยเเล้ว ใช้ .lower() ในการเเปลงตัวอักษรภาษาอังกฤษเป็นพิมพ์เล็ก
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ [::-1] ในการ Reverse String เเล้วเเสดงผลออกมาโดยใช้ .lower() ในการเเปลงเป็นตัวอักษรภาษาอังกฤษพิมพ์เล็ก
```
...
```text
ตรวจสอบว่า Output ออกมาเป็นตัวหนังอักษรภาษาอังกฤษพิมพ์เล็กไหม
```
...
```text
ตรวจสอบว่าถ้าจะ Reverse ตัวเลขที่ input เข้ามาเป็น str ปนกับอักษรภาษาอังกฤษจะผ่านไหม 
```
...
```text
อยากตรวจสอบว่าอักขระพิเศษสามารถ Reverse ได้หรือไม่
```
