...
```text
โจทย์ให้เขียนโปรแกรมแปลงหน่วยอุณหภูมิจากหน่วยหนึ่งไปเป็นอีกหน่วยหนึ่ง โดยมีหน่วยที่เกี่ยวข้องทั้งหมด 4 หน่วย คือ C, F, K, R ในโจทย์จะมีรูปภาพสมการมาให้

Input :
3 บรรทัด
เป็นค่าอุณหภูมิ เป็นจำนวนจริง
ตัวอักษร C, F, K, R เป็นหน่วยของบรรทัดที่ 1
ตัวอักษร C, F, K, R เป็นหน่วยที่ต้องการจะเปลี่ยนไปเป็นตัวนั้น

Output :
เป็นอุณหภูมิในหน่วยเดียวกับ input บรรทัดที่ 3 เป็นจำนวนจริง

Constraints :
input เป็น float เเละ output เป็นทศนิยม 2 ตำเเหน่ง
```
...
```text
1. รับ input เข้ามา 3 บรรทัดใช้ชื่อ temp เเทนค่าอุณหภูมิ, unit_from เเทนตัวอักษรของอุณหภูมิบรรทัดที่ 1, unit_to เเทนตัวอักษรของอุณหภูมิของบรรทัดที่อยากจะเปลี่ยน

2. ผมดูจากสมการที่ให้มาเเล้วมีอุณหภูมิหน่วย C เกี่ยวข้องกับทุกสมการเลยจะเเปลงทุกหน่วยให้กลายเป็น C ก่อนเเล้วค่อยคำนวนหน่วยสุดท้ายตาม input บรรทัดที่ 3 เช่น ถ้า unit_from == "K" เราจะสร้างตัวเเปร set_c มาเก็บ temp - 273.15 คือการเเปลงให้ K ตาม input บรรทัดที่ 2 กลายเป็น C ก่อน

3. พอได้ C มาเเล้วเราก็สามารถเขียนสมการตามรูปที่โจทย์ให้มาได้เลย

4. เเสดงผลอุณหภูมิตามหน่วยที่ input บรรทัดที่ 3 ต้องการ
```
...
```text
ผมใช้เหมือนกับเเผนเเรกเลย เพราะว่าลองเขียนเเล้วมันโอเคร ซึ่งคิดว่าตรงที่เเปลงเป็น C ก่อนเนี่ยลดขั้นตอนการทำง่าน การใช้ if-else ของโค้ดได้เยอะมากครับ
```
...
```text
ตรวจสอบว่า Input บรรทัดที่ 2, 3 เหมือนกันจะได้อุณหภูมิของบรรทัดที่ 1 ออกมาจริงไหม
```
...
```text
ตรวจสอบการเปลี่ยนอุณหภูมิข้ามหน่วย
```
...
```text
ตรวจสอบ input เป็นอุณหภูมิที่ตัวเเรกเป็น C เเล้วเปลี่ยนเป็น ตัวอื่น R, F, K
```
